#!/bin/sh
# create by lucandroid70@gmail.com "luca saturday"
...
apt install apache2-doc apache2-utils apache2-data -y
...
#sudo nano /etc/apache2/apache2.conf  --> ServerName localhost
